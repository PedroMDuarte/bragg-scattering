...
%dependence) \begin{equation} \begin{split} I = & \sum_{mn}
%\eta_{m}\eta_{n}^{*}  \left\langle S_{m+}S_{n-} \right\rangle \end{split}
%\end{equation}
...
\begin{equation}
  \frac{s}{1+s} \approx \frac{ s_{0} }
                             { 4 \Delta^{2} + s_{0} }
\end{equation}
%so the four terms above go respectively to 
%\begin{align} 
%      s_{0}^{2}\frac{   2 \Delta_{m} \Delta_{n} } 
%           {(4 \Delta_{m}^{2} + s_{0})(4 \Delta_{n}^{2} + s_{0})
% }  \\
%      s_{0}^{2}\frac{  +i \Delta_{n} } 
%           {(4 \Delta_{m}^{2} + s_{0})(4 \Delta_{n}^{2} + s_{0})
% }   \\
%     s_{0}^{2} \frac{  -i \Delta_{m} } 
%           {(4 \Delta_{m}^{2} + s_{0})(4 \Delta_{n}^{2} + s_{0})
% }   \\
%     s_{0}^{2} \frac{ 1/2} { (4 \Delta_{m}^{2} + s_{0})(4 \Delta_{n}^{2} + s_{0})
%}   
%\end{align}
...
%$\Iq/\Iqtof$ can be related to the spin structure factor.     
%\begin{equation}
%\begin{split} 
% \frac{\Iq}{\Iqtof} 
%&  =
